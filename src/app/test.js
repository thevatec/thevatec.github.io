...
<script type="text/javascript">
  ...
  accountID: "3521259",
  trustKey: "3521259",
  xpid: "VwMFUFRWARAEUFNVAwAOVVI=",
  licenseKey: "NRJS-0ddb4a9583251a72ea0",
  applicationID: "442741936"
};
  ...
  return r.inPlace(Node.prototype, C, "dom-"),
  ...
  , r = self["webpackChunk:NRBA-1.252.0.PROD"] = self["webpackChunk:NRBA-1.252.0.PROD"] || [];
  ...
  this.abortHandler?.(),
  (0,
  c.L)(this.agentIdentifier, this.featureName, !0),
  o(!1)
}
}
  ;
  ...
  #r(e) {
  return e instanceof Error ? e : void 0 !== e?.message ? new P(e.message,e.filename || e.sourceURL,e.lineno || e.line,e.colno || e.col) : new P("string" == typeof e ? e : (0,
  _.P)(e))
}
  #n(e) {
  ...
  o && ((0,
  T.p)(I.mY, ["Ajax/CrossApplicationTracing/Header/Seen"], void 0, r.D.metrics, t),
